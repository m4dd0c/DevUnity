...
const AceButton: React.FC<IAceButton> = ({
  ...
  return (
    <button
      ...
      } flex items-center justify-center mt-4 mb-5 relative group/btn w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--neutral-800)_inset,0px_-1px_0px_0px_var(--neutral-800)_inset] ${className}`}
